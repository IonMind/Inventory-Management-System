...
public class ItemController {
    ...
    public ResponseEntity<Item> updateItem(@PathVariable Long id, @RequestParam(required = false,defaultValue = "") Integer updatedStock, @RequestParam(required = false,defaultValue = "") Double newPrice) {        
